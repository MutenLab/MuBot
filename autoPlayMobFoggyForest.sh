...
while true; do
  ...
  /Users/icerrate/AndroidStudioProjects/bot/bash/travel/foggyForest/toMobsFromCenter.sh "satan" true &
  reposition_pid=$!
  ...
  if [ $travel_exit_code -eq 1 ]; then
    ...
    # Parameters: duration, keyCode, cooldown, eventTimeCheckEnabled
