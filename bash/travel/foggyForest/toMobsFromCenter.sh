...
sleep 0.5
# Click mob zone
adb_tap 1295 720 # Migrated
sleep 0.5
# Close map
tap_closeMap

# Use travel time to perform optional tasks
runDuringTravelling 28 true "none" true 0 true  # remainTime=28s, performRecycle=true, validationType=none, performGameValidation=true, expectedLocation=0, popupValidation=true
if [ $? -ne 0 ]; then
    exit 1
fi
