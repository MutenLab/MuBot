...
runDuringTravelling 50 true "$validationType" true $LOC_SANCTUARY_1  # remainTime=50s, performRecycle=false, validationType, performGameValidation=true, expectedLocation=Sanctuary1
exit_code=$?
