...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 36 false "none" true $LOC_SANCTUARY_1  # remainTime=36s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=Sanctuary1
    exit_code=$?
    ...
    runDuringTravelling 36 true "$validationType" false  # remainTime=36s, performRecycle=true, validationType, performGameValidation=false
fi
