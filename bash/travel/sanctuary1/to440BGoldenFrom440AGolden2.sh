...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 16 false "none" true $LOC_SANCTUARY_1  # remainTime=13s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=Sanctuary1
    exit_code=$?
