...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 29 false "none" true $LOC_ABYSSAL_FEREA  # remainTime=29s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=AbyssalFerea
    exit_code=$?
    ...
    runDuringTravelling 29 true "$validationType" false  # remainTime=29s, performRecycle=true, validationType, performGameValidation=false
fi
