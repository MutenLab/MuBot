...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 14 true "none" true $LOC_SANCTUARY_1  # remainTime=14s, performRecycle=true, validationType=none, performGameValidation=true, expectedLocation=Sanctuary1
    exit_code=$?
