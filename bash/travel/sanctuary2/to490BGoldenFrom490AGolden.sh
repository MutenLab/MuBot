...
runDuringTravelling 21 true "$validationType" true $LOC_SANCTUARY  # remainTime=22s, performRecycle=true, validationType, performGameValidation=true, expectedLocation=Sanctuary2
exit_code=$?
