...
runDuringTravelling 38 true "$validationType" true $LOC_SANCTUARY  # remainTime=36s, performRecycle=true, validationType, performGameValidation=true, expectedLocation=Sanctuary2
exit_code=$?
