...
runDuringTravelling 67 true "$validationType" true 0  # remainTime=67s, performRecycle=true, validationType, performGameValidation=true, expectedLocation=0(No check)
exit_code=$?
