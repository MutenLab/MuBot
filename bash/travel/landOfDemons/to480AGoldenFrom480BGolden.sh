...
runDuringTravelling 12 true "$validationType" true 0  # remainTime=12s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=0(No check)
exit_code=$?
