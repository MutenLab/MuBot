...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 36 false "none" true $LOC_SANCTUARY  # remainTime=36s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=Sanctuary1
    exit_code=$?
