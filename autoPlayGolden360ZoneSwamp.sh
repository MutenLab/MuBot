...
while true; do
  ...
  sleep 1
  /Users/icerrate/AndroidStudioProjects/bot/bash/travel/swamp/360zone/toGolden360From350.sh &
  to360PID=$!              # Save PID
  ...
  sleep 1
  /Users/icerrate/AndroidStudioProjects/bot/bash/travel/swamp/360zone/toGolden350From360.sh &
  to350PID=$!              # Save PID
