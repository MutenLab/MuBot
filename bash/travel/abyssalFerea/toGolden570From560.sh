...
if [ "$performGameValidation" = "true" ]; then
    ...
    runDuringTravelling 23 false "none" true $LOC_ABYSSAL_FEREA  # remainTime=23s, performRecycle=false, validationType=none, performGameValidation=true, expectedLocation=AbyssalFerea
    exit_code=$?
    ...
    runDuringTravelling 23 true "$validationType" false  # remainTime=23s, performRecycle=true, validationType, performGameValidation=false
fi
